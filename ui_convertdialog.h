...
**
** Created: Sat 5. Feb 01:55:15 2011
...
{
public:
    QGroupBox *groupBox_formats;
    QLineEdit *lineEdit_targetdefinition;
    QPushButton *pushButton_targetdefinition;
    ...
    void setupUi(QDialog *ConvertDialog)
    {
        ...
        ConvertDialog->resize(396, 264);
        groupBox_formats = new QGroupBox(ConvertDialog);
        groupBox_formats->setObjectName(QString::fromUtf8("groupBox_formats"));
        groupBox_formats->setGeometry(QRect(10, 160, 371, 61));
        lineEdit_targetdefinition = new QLineEdit(groupBox_formats);
        lineEdit_targetdefinition->setObjectName(QString::fromUtf8("lineEdit_targetdefinition"));
        lineEdit_targetdefinition->setEnabled(false);
        lineEdit_targetdefinition->setGeometry(QRect(20, 20, 251, 20));
        pushButton_targetdefinition = new QPushButton(groupBox_formats);
        pushButton_targetdefinition->setObjectName(QString::fromUtf8("pushButton_targetdefinition"));
        pushButton_targetdefinition->setGeometry(QRect(280, 20, 75, 23));
        ...
        lineEdit_targetfile->setGeometry(QRect(20, 20, 251, 20));
        ...
        pushButton_convert->setGeometry(QRect(310, 230, 75, 23));
    ...
    void retranslateUi(QDialog *ConvertDialog)
    {
        ...
        groupBox_formats->setTitle(QApplication::translate("ConvertDialog", "target format definition", 0, QApplication::UnicodeUTF8));
        pushButton_targetdefinition->setText(QApplication::translate("ConvertDialog", "Browse", 0, QApplication::UnicodeUTF8));
